  ...
  return (
    <section className="w-full py-24 bg-background">
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* Results Strip */}
        <div className="bg-foreground text-background p-8 md:p-12 mb-24 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 border border-border text-center sm:divide-x sm:divide-y-0 divide-y divide-background/20">
          ...
          <div className="flex flex-col pt-6 sm:pt-0 sm:pl-8 pb-6 sm:pb-0">
