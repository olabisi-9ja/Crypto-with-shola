      ...
      <div style={{
        ...
        <div style={{display: 'flex', flexDirection: 'column', gap: '20px'}}>
          ...
          <div style={{display: 'flex', gap: '15px', marginTop: '10px'}}>
            ...
            <a href="https://t.me/cryptowithshola" target="_blank" rel="noreferrer" style={{color: 'white', opacity: 0.8, transition: 'all 0.2s'}} className="hover-orange">
              <Send size={24} />
            </a>
        ...
        <div>
          ...
          <ul style={{listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '12px'}}>
            ...
            <li><a href="https://t.me/cryptowithshola" target="_blank" rel="noreferrer" style={{color: 'white', textDecoration: 'none', opacity: 0.8, transition: 'all 0.2s'}} className="hover-orange">Join Telegram</a></li>
          </ul>
        </div>
